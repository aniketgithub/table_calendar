...
/// Callback exposing left righ cheveron tap
typedef void OnPreviousSelected();

/// Callback exposing the righ cheveron tap
typedef void OnNextSelected();
...
class TableCalendar extends StatefulWidget {
  ...
  /// Called whenever header's left chevron gets tapped.
  final OnPreviousSelected onPreviousSelected;

  /// Called whenever header's right chevron gets tapped.
  final OnNextSelected onNextSelected;
